...
/**
 * [LeveledLogJournal] implementation that logs on INFO logging level.
 *
 * Ignores attempt to log on TRACE or DEBUG level.
 *
 * Delegates logging to underlying [LogJournal]
 *
 * @author Alex Ilyushkin
 */
class InfoLeveledLogJournal(
    ...
    override fun logDebug(message: Message) {
        //Do nothing. Logging level of the leveled log journal is higher than DEBUG
    }
