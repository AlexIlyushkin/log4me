...
/**
 * [LeveledLogJournal] implementation that logs on ERROR logging level.
 *
 * Ignores attempt to log on TRACE or DEBUG or INFO or WARNING level.
 *
 * Delegates logging to underlying [LogJournal]
 *
 * @author Alex Ilyushkin
 */
class ErrorLeveledLogJournal(
    ...
    override fun logWarning(message: Message) {
        //Do nothing. Logging level of the log journal is higher than WARNING
    }
